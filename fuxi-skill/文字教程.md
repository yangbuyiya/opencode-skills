...
![](https://pic.code-nav.cn/migrate_image/456feb8fc03841068243dae435ad0d43.webp)
...
![](https://pic.code-nav.cn/migrate_image/ad280b035e927348830197fa9a4bcb69.webp)
...
![](https://pic.code-nav.cn/migrate_image/4b4769b5c942eb5a23558623474242b0.webp)

选择依赖，使用 3.5.x 版本的 Spring Boot，引入 Spring MVC 和 Lombok 注解库：

![](https://pic.code-nav.cn/migrate_image/b0d19775336bdc0fc52027a8ce3c1403.webp)

新建项目后，先修改配置文件后缀为 `yml`，便于后面填写配置。

![](https://pic.code-nav.cn/migrate_image/9456fa4d70d3099134d3f809325f5909.webp)
...
![](https://pic.code-nav.cn/migrate_image/bbec1714383b4e95e93b25b95be5ba96.webp)
...
![](https://pic.code-nav.cn/migrate_image/dd815cebcb049d096bd7d56e645c60be.webp)
...
![](https://pic.code-nav.cn/migrate_image/cdfb9bbb39fbd693322bf012a9334f9c.webp)

如果遇到找不到符号的 lombok 报错：

![](https://pic.code-nav.cn/migrate_image/e37a97b91bfa6c1e09602e524446ddb9.webp)
可以修改 IDEA 的注解处理器配置，改为使用项目中的 lombok：

![](https://pic.code-nav.cn/migrate_image/48dcc380b8621a355c6aff02e7a681c0.webp)
...
![](https://pic.code-nav.cn/migrate_image/67b58e53a957d1215f1596db0fe3c7a0.webp)

LangChain4j 中使用多模态的方法很简单，用户消息中是可以添加图片、音视频、PDF 等媒体资源的。

![](https://pic.code-nav.cn/migrate_image/1a5e19d2ff130ab37e6f7f25310b161c.webp)
...
![](https://pic.code-nav.cn/migrate_image/764b289d69ae93809baa88d6bd252770.webp)

![](https://pic.code-nav.cn/migrate_image/fdbaa423b5080297c2a982919e6fe403.webp)
...
![](https://pic.code-nav.cn/migrate_image/335eb47c39d87d2af7ee1caa33d23bef.webp)
...
![](https://pic.code-nav.cn/migrate_image/a58c169bd3f258832d4368b7e4b34065.webp)
...
![](https://pic.code-nav.cn/migrate_image/f87bc2659a5fb264dae8c77a3904f7b6.webp)
...
![](https://pic.code-nav.cn/migrate_image/aede86a7dda85f450bcf0dd229c85013.webp)
...
![](https://pic.code-nav.cn/migrate_image/04280f79a7c691ff9cec36c5833430f0.webp)
...
![](https://pic.code-nav.cn/migrate_image/c08167c50a79d62afed818e18da1537e.webp)

查看输出结果，会话记忆生效：

![](https://pic.code-nav.cn/migrate_image/d72b29d7119f094b0be62ca2a2bd3ec8.webp)
...
![](https://pic.code-nav.cn/migrate_image/76a357aaffa7116eb7a7a092b5dac220.webp)
...
![](https://pic.code-nav.cn/migrate_image/bc7ad496eb4dfd982bfcab6e33f60a23.webp)
...
![](https://pic.code-nav.cn/migrate_image/a7f865a506daaceadbd43c2d02eefd58.webp)
...
![](https://pic.code-nav.cn/migrate_image/0be7ca538a4a823d3901cdc28f523a60.webp)
...
![](https://pic.code-nav.cn/migrate_image/86ad9689113d46f817fcaf76db7c78b6.webp)

让我们来实操一下，首先我准备了 4 个文档，放在了 `resources/docs` 目录下：

![](https://pic.code-nav.cn/migrate_image/1bfcfaf2cac59f3932e5b1f273075e6e.webp)
...
![](https://pic.code-nav.cn/migrate_image/6ef7cabb2aa6eba761f817ff6fc91329.webp)

可以在对话记忆中看到实际发送的、增强后的 Prompt：

![](https://pic.code-nav.cn/migrate_image/fa2d7b433fa5edbdaa3e570509bbba88.webp)

![](https://pic.code-nav.cn/migrate_image/ad230f2e6a9b69a6b49bb712f588a297.webp)

回答效果也是符合预期的：

![](https://pic.code-nav.cn/migrate_image/7f7afa6e6651473672b3e15f8b866066.webp)
...
![](https://pic.code-nav.cn/migrate_image/3f16515c567c74c2690df0123a4ff4ef.webp)
...
![](https://pic.code-nav.cn/migrate_image/5f61958ca6979aa6e4ecb78722f72aa4.webp)

#### 进阶版 RAG

这就是一套标准的 RAG 实现了，大多数时候，使用标准版就够了。进阶版会更加灵活，额外支持查询转换器、查询路由、内容聚合器、内容注入器等特性，将整个 RAG 的流程流水线化（RAG pipeline）。

![](https://pic.code-nav.cn/migrate_image/9525353929d20327c1dec8643d258bac.webp)
...
![](https://pic.code-nav.cn/migrate_image/6a72822e5b02ba4c0b18f3fc3307e5c7.webp)
...
![](https://pic.code-nav.cn/migrate_image/abf7813690cf2e9328b5d3f33bd26754.webp)
...
![](https://pic.code-nav.cn/migrate_image/487e6bf2d2cd384f71262a15aa124596.webp)
...
![](https://pic.code-nav.cn/migrate_image/c61eb46d5efd527dc82b2915419e9c6c.webp)

工具检索到了题目列表：

![](https://pic.code-nav.cn/migrate_image/fe465215676aab9557a7a3ea9d04901f.webp)

可以通过 Debug 看到 AI Service 加载了工具：

![](https://pic.code-nav.cn/migrate_image/593d4f62e3dc0b96329aee089eaa5e02.webp)

可以通过会话记忆查看工具的调用过程：

![](https://pic.code-nav.cn/migrate_image/08a49115ef814437754ae0c3c065777b.webp)

输出结果符合预期：

![](https://pic.code-nav.cn/migrate_image/9caa36769b14dc80ff789ada41bb67a4.webp)

前面只演示了最简单的工具定义方法 —— 声明式，LangChain4j 也提供了编程式的工具定义方法，不过我相信你不会想这么做的（除非是动态创建工具）。

![](https://pic.code-nav.cn/migrate_image/6a05c8bdaa2da04563e08625737b3ccc.webp)
...
![](https://pic.code-nav.cn/migrate_image/e62a37911e1e285a2d7fce936a58897a.webp)
...
![](https://pic.code-nav.cn/migrate_image/0b23cf0f01fda0c9436d36a122c920e3.webp)

但也要注意，用别人的服务可能是需要 API Key 的，一般是按量付费。

需要先去 [平台官方获取 API Key](https://www.bigmodel.cn/usercenter/proj-mgmt/apikeys)，等会儿会用到：

![](https://pic.code-nav.cn/migrate_image/e62c3478c1dff7e5db08d59f3d0cd83d.webp)

然后我们要在程序中使用这个 MCP 服务。比较坑的是，感觉 LangChain 对 MCP 的支持没有那么好，官方文档甚至都没有提到要引入的 MCP 依赖包。我还是从开源仓库中找到的依赖：

![](https://pic.code-nav.cn/migrate_image/1cdeb581c9b00ab21da04b7fc7aceb8b.webp)
...
![](https://pic.code-nav.cn/migrate_image/c66ae7fca6843d628b091f7bf6651980.webp)

MCP 服务生效，从网上检索到了内容作为答案：

![](https://pic.code-nav.cn/migrate_image/7fac6d812b7e52080f22634f0ea594a9.webp)
...
![](https://pic.code-nav.cn/migrate_image/8644302188889e4d33241bdcc68bc30f.webp)
...
![](https://pic.code-nav.cn/migrate_image/d55fa935f8c9795919bffc382dc345e9.webp)
...
![](https://pic.code-nav.cn/migrate_image/6c0bb09f896a3ce20a701a37af2e5b62.webp)

如果不包含敏感词，则会顺利通过。

![](https://pic.code-nav.cn/migrate_image/069cb662a8e3e8bcac7b64931c19d48f.webp)
...
![](https://pic.code-nav.cn/migrate_image/241f0330d3b603e641293a6efaf14506.webp)
...
![](https://pic.code-nav.cn/migrate_image/23914f4d5c7dae4d4d222265ba760632.webp)
...
![](https://pic.code-nav.cn/migrate_image/d5deae2c60edc2e535dd49aa0ed544c7.webp)

除了源代码外，鱼皮这里连项目介绍文档 `README.md` 都生成了，确实很爽！

![](https://pic.code-nav.cn/migrate_image/198208d353d3b4a8c3531e4cd29bfcf0.webp)

生成完代码后，打开终端执行 `npm run dev` 命令，或者打开 `package.json` 文件并利用 Debug 按钮启动项目：

![](https://pic.code-nav.cn/migrate_image/df6816fd37e2c087ffadf603bb0a7850.webp)
...
![](https://pic.code-nav.cn/migrate_image/17ccae7f9c5f5b342693a8ea640e2b5b.webp)

成功运行，查看效果：

![](https://pic.code-nav.cn/migrate_image/18aa1bee692e87af6134f116bfc46678.webp)

![](https://pic.code-nav.cn/migrate_image/5fccef783e822323499a9e72fa51c750.webp)

确保功能和样式没问题后，记得先提交代码（防止后续被 AI 生成的代码污染），然后你可以按需增加更多功能，比如用 Markdown 展示 AI 的回复消息。

![](https://pic.code-nav.cn/migrate_image/27cc60136951490cfa800b3592378550.webp)
...
![](https://pic.code-nav.cn/migrate_image/82ee35fa754e7c2713097c1aa76f8f6a.webp)
